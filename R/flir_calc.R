...
dir_FLIRimages = "raw_data/FLIR/images/"

# load functions modified from rasenior/ThermStats
source("R/functions/batch_FLIR.r")

# output directory
out_dir <- "raw_data/FLIR/output/"


# read df of file codes
flir_df <- read.csv("raw_data/FLIR/PFTC7_SA_FLIR_2023.csv") |>
...
flir_results <- flir_df |> left_join(stats, by = "file_number")
